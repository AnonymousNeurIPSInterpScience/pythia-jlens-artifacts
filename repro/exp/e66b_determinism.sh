#!/usr/bin/env bash
# e66b_determinism — WHY UNSTATED — add it to KNOWN
#
# GENERATED by tools/emit_exp_modules.py from results/e66b_determinism_floor.json. Do not hand-edit; regenerate.
...
MODULE_ID="e66b_determinism"; MODULE_TITLE="WHY UNSTATED — add it to KNOWN"
MODULE_WHY="WHY UNSTATED — add it to KNOWN"
MODULE_COST="GPU — price with ./lab cost before running"
MODULE_TIER="T2"
INPUTS=(results/e48/lens_INSTREAM_Pile-CC_410m_n200_s0.pt results/e66_fitter_equivalence_cuda.json)
OUTPUTS=(results/e66b_determinism_floor.json)
main() { run_py experiments/e66b_determinism_floor.py; }
module_main "$@"
