#!/usr/bin/env bash
# cv8_positional — WHY UNSTATED — add it to KNOWN
#
# GENERATED by tools/emit_exp_modules.py from results/cv8_positional_extrapolation.json. Do not hand-edit; regenerate.
...
MODULE_ID="cv8_positional"; MODULE_TITLE="WHY UNSTATED — add it to KNOWN"
MODULE_WHY="WHY UNSTATED — add it to KNOWN"
MODULE_COST="free (CPU)"
MODULE_TIER="T1"
INPUTS=(results/cv2_position_support.json results/r9_permutation_calibrated_min.json)
OUTPUTS=(results/cv8_positional_extrapolation.json)
main() { run_py experiments/cv8_positional_extrapolation.py; }
module_main "$@"
