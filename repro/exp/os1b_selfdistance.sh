#!/usr/bin/env bash
# os1b_selfdistance — WHY UNSTATED — add it to KNOWN
#
# GENERATED by tools/emit_exp_modules.py from results/os1b_selfdistance_floor.json. Do not hand-edit; regenerate.
...
MODULE_ID="os1b_selfdistance"; MODULE_TITLE="WHY UNSTATED — add it to KNOWN"
MODULE_WHY="WHY UNSTATED — add it to KNOWN"
MODULE_COST="free (CPU)"
MODULE_TIER="T1"
INPUTS=(results/e48/lens_INSTREAM_Pile-CC_410m_n200_s0.pt)
OUTPUTS=(results/os1b_selfdistance_floor.json)
main() { run_py experiments/os1b_selfdistance_floor.py; }
module_main "$@"
