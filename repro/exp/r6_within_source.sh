#!/usr/bin/env bash
# r6_within_source — corpus identity, or sampling within a corpus?
#
# GENERATED by tools/emit_exp_modules.py from results/r6_within_source_410m.json. Do not hand-edit; regenerate.
...
MODULE_ID="r6_within_source"; MODULE_TITLE="corpus identity, or sampling within a corpus?"
MODULE_WHY="corpus identity, or sampling within a corpus?"
MODULE_COST="GPU — price with ./lab cost before running"
MODULE_TIER="T2"
INPUTS=(corpora/Pile-CC.jsonl corpora/Wikipedia_en.jsonl)
OUTPUTS=(results/r6_within_source_410m.json)
main() { run_py experiments/r6_within_source.py --device cuda --lens-dir results/r6 --out results/r6_within_source_410m.json; }
module_main "$@"
