...
The rule is `specs/archive/prereg/PREREG_E48_CROSSOVER.md` + Amendment 1, committed at `408fa5c` /
...
def lens_path(corpus: str, seed: int) -> str:
    ...
    return os.path.join(HERE, "..", "results", f"e28_{corpus}_410m_n200_s{seed}.pt")
...
def main() -> int:
    ...
    run("C0_ref_Github_n400_s0", load_J(os.path.join(HERE, "..", "results",
                                                     "e28_Github_410m_n400_s0.pt")))
    ...
    rec = {
        ...
        "prereg": "specs/archive/prereg/PREREG_E48_CROSSOVER.md + Amendment 1, commits 408fa5c / 5869b63",
