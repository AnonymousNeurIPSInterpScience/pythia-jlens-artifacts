...
PRE-REGISTRATION: specs/experiments/R3_ladder410_cpu.md, committed before this script existed.
Source slate: specs/POSTREVIEW_EXPERIMENTS.md §3 Tier A, item R3.
...
def main() -> int:
    ...
    rec = {"experiment": "R3 — closing D2 by re-scoring the 410M ladder on CPU",
           ...
           "prereg": "specs/experiments/R3_ladder410_cpu.md",
           "prereg_sha256": sha256_file(R("specs", "experiments", "R3_ladder410_cpu.md")),
