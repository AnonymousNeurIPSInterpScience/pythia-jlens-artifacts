...
PRE-REGISTRATION: specs/experiments/R4_corrections.md, committed before this script existed.
Source slate: specs/POSTREVIEW_EXPERIMENTS.md §3 Tier A, item R4.
...
def r4h():
    ...
    items["M-22b_fit_prefix_overlap"] = {
        ...
        "verdict": ("the measurement is 0.17043, so a ~17% guess was VINDICATED to 0.04 pp rather "
                    ...
                    "paper/CONTEXT.md and specs/RESULTS_TAXONOMY.md -- and RESULTS_TAXONOMY.md:66 "
                    "already states the correction in place, which the reviewer's note missed"),
        "note_on_the_reviewers_claim": ("checked directly: specs/RESULTS_TAXONOMY.md:66 reads "
    ...
    items["M-16_E52_diagonal_excess_D"] = {
        ...
        "verdict": ("PARTLY REFUTED, as the slate says. specs/archive/prereg/PREREG_E52_FACTORIAL.md:69 "
...
def r4l():
    ...
    for f, cls, where in [
        ("e31_local_bakeoff_410m.json", "criterion-only",
         "the file's `prereg` field is null; specs/experiments/E31_predictor_bakeoff.md records a "
        ...
        ("e38_jgeometry.json", "independent-file",
         "specs/archive/prereg/PREREG_E38_JGEOMETRY.md — an independent timestamped document"),
