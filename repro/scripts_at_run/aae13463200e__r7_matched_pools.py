...
PRE-REGISTRATION: specs/experiments/R7_length_matched_pools.md, committed before this ran.
Source slate: specs/POSTREVIEW_EXPERIMENTS.md §3 Tier B, item R7.
...
def main() -> int:
    ...
    prereg = "specs/experiments/R7_length_matched_pools.md"
