...
PRE-REGISTRATION: specs/experiments/E65_training_axis_floor.md, written before this ran.
...
def main() -> int:
    ...
    rec = {
        ...
        "prereg": "specs/experiments/E65_training_axis_floor.md", "status": "PRE-REGISTERED",
        ...
        "N": n_fit, "seed_block": SEED_BLOCK, "n_derangements": N_DERANGE,
    ...
    out = a.out or os.path.join(HERE, "..", "results", f"e65_ckpt_readout_{a.model}.json")
