...
WHY THIS EXISTS
  ...
  — appears in PLAN.tex, SPINE.tex, RESULTS.tex, HANDOFF.md, EXTREVIEW_PROMPT_ODMATRIX.md and
...
def main() -> int:
    ...
    for scale, d in (("410m", os.path.join(HERE, "..", "results", "ladder410")),
                     ("1b", os.path.join(HERE, "..", "results", "ladder1b"))):
    ...
    write_result(a.out, rec, experiment="E51",
                 inputs=sorted(glob.glob(os.path.join(HERE, "..", "results", "ladder410", "*.json")))
