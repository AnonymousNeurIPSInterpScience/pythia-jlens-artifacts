...
def audit_e36(agg: str) -> dict:
    d = json.load(open(os.path.join(RES, "e36_qladder_410m.json")))["ladder"]
...
def audit_e52(agg: str) -> dict:
    b = json.load(open(os.path.join(RES, "e52_factorial_410m.json")))["by_aggregation"][agg]
...
def audit_quadrants(agg: str) -> dict:
    ...
    """
    M = json.load(open(os.path.join(RES, "e52_factorial_410m.json")))["by_aggregation"][agg]["matrix"]
...
def audit_baseline_movement(agg: str) -> dict:
    ...
    lad = json.load(open(os.path.join(RES, "e36_qladder_410m.json")))["ladder"]
...
def audit_derangement() -> dict:
    ...
    A = json.load(open(os.path.join(RES, "e48_crossover_410m.json")))["arms_admitted_mean"]
...
def main() -> int:
    ...
    res = {
        ...
        "inputs": ["results/ladder410/*.json", "results/ladder1b/*.json",
                   "results/e33_logit_baseline_410m_v2.json", "results/e36_qladder_410m.json",
                   "results/e48_crossover_410m.json", "results/e48c_exposure_vs_read.json",
    ...
    e52p = json.load(open(os.path.join(RES, "e52_factorial_410m.json")))["adjudication"]
