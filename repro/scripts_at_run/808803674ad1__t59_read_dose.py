...
PRE-REGISTRATION: specs/experiments/E59_read_dose_response.md, written before this ran.
...
def main() -> int:
    ...
    ap.add_argument("--out", default=os.path.join(HERE, "..", "results", "e59_read_dose_410m.json"))
    a = ap.parse_args()
    ...
    e52 = json.load(open(os.path.join(HERE, "..", "results", "e52_factorial_410m.json")))
    ...
    rec = {
        ...
        "prereg": "specs/experiments/E59_read_dose_response.md, written before this ran",
