...
PRE-REGISTRATION: docs/experiments/preregs/R5_corpus_axis_uncertainty.md.
Source slate: POSTREVIEW_EXPERIMENTS.md §3 Tier B, item R5.
...
def main() -> int:
    ...
    rec = {
        ...
        "prereg_sha256": sha256_file(R("docs", "experiments", "preregs", "R5_corpus_axis_uncertainty.md")),
