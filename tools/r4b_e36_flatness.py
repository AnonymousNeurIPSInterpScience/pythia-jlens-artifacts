...
PRE-REGISTRATION: docs/experiments/preregs/R4b_e36_rstrip.md, committed before this script existed.
Source slate: POSTREVIEW_EXPERIMENTS.md §3 Tier B, item R4b.
...
def main() -> int:
    ...
    if n >= 4:
        ...
        verdict = (f"REJECT OVERTURNED — flatter on only {n} of 5. FLAGGED FOR ADJUDICATION. "
    ...
    rec = {"experiment": "R4b — E36's shift-axis slopes at the corrected readout",
           "prereg": "docs/experiments/preregs/R4b_e36_rstrip.md",
           "prereg_sha256": sha256_file(R("docs", "experiments", "preregs", "R4b_e36_rstrip.md")),
