#!/usr/bin/env python3
"""postreview_completion.py — map every item in POSTREVIEW_EXPERIMENTS.md to its outcome.
...
SLATE = "POSTREVIEW_EXPERIMENTS.md"
...
MAP = {
 ...
 "P0":  ("docs/experiments/preregs/P0_t52_parallel_port.md", ["results/e52_factorial_410m_pooled.json"],
         "port a process pool into t52_factorial.py"),
 "R1":  ("docs/experiments/preregs/R1_grid_rstrip.md",
 ...
 "R2":  ("docs/experiments/preregs/R2_e48_rstrip_arm.md", ["results/e48_crossover_410m_rstrip.json"],
         "the declared-but-never-run --rstrip sensitivity arm on E48"),
 "R3":  ("docs/experiments/preregs/R3_ladder410_cpu.md", ["results/r3_close_d2.json"],
         "close D2 — re-score ladder410 on CPU and re-derive"),
 "R4":  ("docs/experiments/preregs/R4_corrections.md",
 ...
 "R4b": ("docs/experiments/preregs/R4b_e36_rstrip.md", ["results/r4b_e36_flatness.json"],
         "re-score E36 — S3's READ-axis rejection is a logit-lens comparison"),
 "R5":  ("docs/experiments/preregs/R5_corpus_axis_uncertainty.md",
 ...
 "R6":  ("docs/experiments/preregs/R6_within_source_resampling.md",
 ...
 "R7":  ("docs/experiments/preregs/R7_length_matched_pools.md", ["results/r7_matched_pools_410m.json"],
         "length- and format-matched fitting pools"),
 "R8":  ("docs/experiments/preregs/R8_ladder_rstrip_S2.md", ["results/r8_ladder_flatness.json"],
         "slate §5 item S-1, self-promoted to Tier A by R1's QUALIFIED verdict — closes S2"),
 "R9":  ("docs/experiments/preregs/R9_permutation_calibrated_min.md",
         ["results/r9_permutation_calibrated_min.json"],
         "permutation-calibrated min — dissolves the metric circularity"),
}


# The adjudication lives in the docs/experiments/preregs/ document, not always in the results file:
