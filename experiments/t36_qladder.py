...
THIS IS THE EXPERIMENT E48 IS NOT.
  ...
  **Nothing in this programme has ever varied Q.** This does.
  ...
  Pre-registration: `docs/experiments/preregs/superseded/PREREG_E36_QLADDER.md`, written 2026-08-13, before any E36
...
def lens_path(corpus: str) -> str:
    return os.path.join(HERE, "..", "results", "lenses", "e28", f"e28_{corpus}_410m_n400_s0.pt")
...
def main() -> int:
    ...
    rec = {
        ...
        "prereg": "docs/experiments/preregs/superseded/PREREG_E36_QLADDER.md (2026-08-13, before any E36 number existed)",
        "prereg_r4b": "docs/experiments/preregs/R4b_e36_rstrip.md",
