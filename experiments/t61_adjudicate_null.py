...
PRE-REGISTRATION: docs/experiments/preregs/E61_randomized_network_null.md, written before the run.
...
def main() -> int:
    ...
    rec = {"experiment": "E61 — the randomized-network null (dead salmon)",
           "prereg": "docs/experiments/preregs/E61_randomized_network_null.md",
