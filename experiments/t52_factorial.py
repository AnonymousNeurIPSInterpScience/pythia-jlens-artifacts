...
PRE-REGISTRATION: docs/experiments/preregs/superseded/PREREG_E52_FACTORIAL.md, written before this ran.
...
# docs/experiments/preregs/P0_t52_parallel_port.md. It says to keep the operators in the parent and let
...
def main() -> int:
    ...
    _prereg = [("docs/experiments/preregs/superseded/PREREG_E52_FACTORIAL.md", "E52, the original design"),
               ("docs/experiments/preregs/P0_t52_parallel_port.md", "P0, the pool port"),
               ("docs/experiments/preregs/R1_grid_rstrip.md", "R1, the readout correction")]
    rec = {
        "experiment": "E52 — the fit x read factorial: J^Q read on Q, the missing cell",
        "prereg": "docs/experiments/preregs/superseded/PREREG_E52_FACTORIAL.md, written before this ran",
